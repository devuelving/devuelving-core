...
class ProductModel extends Model
{
     ...
     */
    protected $fillable = [
        'slug', 'name', 'description', 'stock_type', 'minimum_stock', 'weight', 'measure', 'tax', 'brand', 'tags', 'parent', 'franchise', 'promo', 'unavailable', 'price_rules', 'meta_title', 'meta_description', 'meta_keywords',
    ];
